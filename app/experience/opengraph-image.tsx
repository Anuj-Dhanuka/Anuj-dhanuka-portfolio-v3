...
export const alt = "Professional experience of Anuj Dhanuka, React and React Native Developer"
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 22, maxWidth: 1020 }}>
        <div style={{ display: "flex", fontSize: 72, fontWeight: 800, lineHeight: 1.08, letterSpacing: -3 }}>
          From client delivery to product ownership.
        </div>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", fontSize: 25, color: "#e9d5ff" }}>
        ...
        <span>anujdhanuka.com/experience</span>
      </div>
    </div>,
    size,
  )
