...
export const alt = "Anuj Dhanuka — Software Engineer & Frontend Developer"
  ...
  return new ImageResponse(
    <div
      style={{
        ...
        padding: "80px",
        background: "linear-gradient(135deg, #0F0F1E 0%, #1A1033 50%, #2A0F3F 100%)",
        color: "white",
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", color: "#9CA3AF" }}>2+ years · 20+ client projects</div>
      </div>
    </div>,
    { ...size },
  )
