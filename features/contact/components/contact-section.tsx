...
export function ContactSection({ deferForm = false }: { deferForm?: boolean }) {
  return (
    <section
      ...
      className="relative isolate scroll-mt-20 overflow-hidden bg-white py-16 dark:bg-gray-900 md:scroll-mt-24 md:py-24"
    >
      <div
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto mb-9 max-w-3xl text-center md:mb-11">
          ...
          <h2 id="contact-section-heading" className="type-section copy-heading">
