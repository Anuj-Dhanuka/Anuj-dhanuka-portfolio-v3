      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative z-10 grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            ...
            <h2 className="type-display mt-6 max-w-3xl copy-heading">Building With Purpose</h2>

            <div className="mt-6 max-w-2xl space-y-4 text-base leading-8 copy-body">
              <p>
              ...
              <p>
                I turn Figma designs and product requirements into polished, responsive interfaces with a
                strong focus on usability, visual consistency and real business needs.
              </p>
            </div>
            ...
            <div className="grid gap-4 lg:block">
              {capabilityCards.map(({ label, title, description, Icon, className }, index) => (
                <article
                  key={title}
                  className={[
                    "group relative w-full rounded-lg border border-purple-100 bg-white/90 p-5 text-left shadow-[0_1px_0_rgba(15,23,42,0.04),0_18px_50px_rgba(124,58,237,0.1)] backdrop-blur-xl transition duration-300 hover:-translate-y-1 hover:border-brand-300 hover:bg-white hover:shadow-[0_1px_0_rgba(15,23,42,0.04),0_26px_70px_rgba(124,58,237,0.18)] motion-reduce:transform-none dark:border-purple-800/35 dark:bg-gray-950/70 dark:hover:border-brand-600/70 lg:absolute lg:w-[58%]",
                    className,
                  ].join(" ")}
                ...
                >
                  ...
                  <h3 className="type-card mt-2 copy-heading">{title}</h3>
