      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
          ...
          >
            ...
            <h2 className="type-display mt-5 max-w-2xl copy-heading">Learning Beyond Development</h2>
            ...
            <div className="mt-6 max-w-2xl space-y-4 text-base leading-8 copy-body">
              <p>
                I have had the opportunity to learn under the guidance of Anjaneyulu Jadda, founder of PPCROY
                TECH SOLUTIONS and Scale Minds.
              </p>
              <p>
                His mentorship helped me strengthen my understanding of user-focused design, digital strategy,
                professional responsibility and the relationship between product experiences and business
                goals.
              </p>
            </div>
            <div className="mt-7">
              ...
              >
                <Link
                  href="https://www.linkedin.com/in/anjaneyulu-jadda/"
                  target="_blank"
              ...
              <div className="grid gap-5 border-b border-purple-100 pb-5 dark:border-purple-800/35 sm:grid-cols-[170px_1fr] sm:items-center">
                ...
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <h3 className="type-card-large mt-2 copy-heading">Guidance that shaped my approach</h3>
                  </div>
              ...
              <div className="mt-5 grid gap-3 sm:grid-cols-2">
                {learningAreas.map(({ label, Icon }, index) => (
                  ...
                  >
                    ...
                    <p className="type-body mt-4 font-bold copy-heading">{label}</p>
                  </motion.div>
                ))}
              </div>
            </div>
