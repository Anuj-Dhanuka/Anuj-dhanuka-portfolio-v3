...
import { Bot, Code2, GitBranch, MonitorSmartphone, PenTool, ShoppingBag, Sparkles } from "lucide-react"
    ...
    >
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="type-section copy-heading">Skills Built Through Real Work</h2>
        ...
        <div className="mt-10 grid gap-5 md:mt-12 md:grid-cols-2 xl:grid-cols-3">
          {skillGroups.map(({ title, skills, Icon }, index) => (
            ...
            >
              ...
              <div className="relative">
                ...
                <h3 className="type-card mt-5 copy-heading">{title}</h3>
          ...
          >
            ...
            <div className="relative">
              ...
              <h3 className="type-card mt-5 copy-heading">AI-Assisted Tools</h3>
              ...
              <p className="type-small mt-4 font-medium text-gray-700 dark:text-gray-200">
                I use AI tools to support research, debugging and development while keeping technical
                decisions and final implementation under my control.
              </p>
            </div>
          </motion.article>
        </div>
