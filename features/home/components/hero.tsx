...
const companyCards: {
...
}[] = [
  {
    ...
    className: "right-[18px] top-[104px] sm:right-[22px] sm:top-[120px] md:right-[28px] md:top-[132px]",
    duration: 6.2,
    delay: 0.9,
    darkBg: false,
  },
  ...
  },
  {
    ...
    className: "left-[52px] bottom-[90px] sm:left-[68px] sm:bottom-[100px] md:left-[84px] md:bottom-[110px]",
    duration: 7.4,
    delay: 1.3,
    darkBg: false,
  },
